...
export function ContactBar() {
  ...
  return (
    <motion.div
      ...
      className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-4 hover:border-[#ff6b35] transition-all"
    >
      gg
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          {socials.map((social, index) => (
            <motion.a
              ...
              whileHover={{ y: -2 }}
              className="flex items-center gap-2 bg-[#0a0a0a] border border-[#2a2a2a] px-4 py-2 rounded-lg text-[#9a9a9a] hover:text-[#ff6b35] hover:border-[#ff6b35] transition-all group"
            >
