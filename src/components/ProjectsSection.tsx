            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {projects.map((project, index) => (
                    ...
                    >
                        <div
                            key={index}
                            className="group bg-soft-cream dark:bg-navy-soft rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-border dark:border-border/20 flex flex-col h-full"
                        >
                            <div
